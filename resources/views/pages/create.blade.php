        ...
        <form method="POST" action="/pages" enctype="multipart/form-data">
            ...
            <div class="form-group row">
                ...
                <div class="col-xl-9 col-md-9 col-12">
                    <input type="text" class="form-control" id="subdomain" placeholder="subdomain" name="subdomain" value="{{ old('subdomain') }}">
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-xl-9">
                    <input type="text" class="form-control" id="company_name" placeholder="Nejron" name="company_name" value="{{ old('company_name') }}">
                </div>
            </div>
            <div class="form-group row">
                ...
                <div class="col-xl-9">
                    <input type="text" class="form-control" id="description" placeholder="Генератор landing page" name="description" value="{{ old('description') }}">
                </div>
            </div>
            <div class="form-group row">
                ...
                <div class="col-xl-9">
                    <input type="text" class="form-control" id="phone" placeholder="+7 929 116 85 65" name="phone" value="{{ old('phone') }}">
                </div>
            </div>
            <div class="form-group row">
